...
SET REPO_DOWNLOAD_URL=https://github.com/Nageswards/Face-Detection/releases/download/v1.0.0/Face-Detection.zip
SET REPO_DEPENDENCIES_URL=https://github.com/Nageswards/Face-Detection/raw/v1.0.0/requirements.txt
SET REPO_NAME=Face-Detection.zip
SET EXTRACTED_REPO_DIR=Face-Detection
SET NOTEBOOK_NAME=Face_detection.ipynb
where /q python
IF ERRORLEVEL 1 (
	ECHO==========================================================================
